...
const SERVER_INSTRUCTIONS =
  ...
  'chosen SKU ($5-$100, tax included; you cover the SKU at cost — no item fee — and the sale runs ' +
  'through your register) — and a shopper bonus ($20-$200, +33% fee on the bonus only, the only ' +
  'platform fee; every $20 = +1 photo and +1 social set per shopper, max +3 each). ' +
